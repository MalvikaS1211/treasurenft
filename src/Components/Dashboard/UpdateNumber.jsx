...
import { getTransactionHash, updateNumber } from "../../Helper/API_Functions";
...
export default function UpdateNumber() {
    ...
    const handleClick = async () => {
        ...
        try {
            setLoading(true);
            const res = await updateNumber(address, phoneNumber);
            ...
            if (res?.success) {
                ...
                toast.error(res?.message || "Invalid phone number");
            }
        } catch (error) {
