...
import { get72HoursTrade } from "../Helper/API_Functions";
import { useAccount } from "wagmi";
import moment from "moment";
export default function TradeHistory() {
  const { address } = useAccount();
  // const address = "0x7E6E14640d777608d2157599c69650720219Af44";
  ...
  const handleTableData = async () => {
    const res = await get72HoursTrade(address, currentPage, itemPerpage);
    ...
    <>
      <div className="p-4 dashboardbg">
        <main className="content-dashboard">
          <Navbar title="Trade History (72 hours)" />
